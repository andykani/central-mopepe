...
<main>
    <header class="bg-white dark:bg-gray-900">
        ...
        <div class="container mx-auto px-6 py-16 pt-20 text-center">
            <div class="mx-auto max-w-lg">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">Faciltez vos déplacements avec <br> {{__('profile.appName')}}</h1>

            <p class="my-8 text-gray-500 dark:text-gray-300">L’air est l’une des ressources les plus précieuses et chez Mopepe, nous l’avons vite compris et avons cherché comment préserver sa qualité pour les générations futures..</p>
            ...
            <div class="container">
                <h1 class="text-3xl mt-16 font-bold text-gray-800 dark:text-white md:text-4xl">Nos partenaires</h1>
            </div>
    ...
    <div class="container mx-auto px-6 py-8">
        <div class="grid justify-items-center grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">

            <div class="w-[100%]">
                <p class="text-3xl font-semibold text-gray-800 dark:text-white">Nos projets</p>

                <div class="mt-5 flex flex-col items-start space-y-2">
                <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">{{__('profile.appName')}} Ecoride</a>
                <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">{{__('profile.appName')}} Refill</a>
                <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">{{__('profile.appName')}} Go Charge</a>
                </div>
            </div>
        ...
        <a href="#" class="text-xl font-bold text-gray-800 transition-colors duration-300 hover:text-gray-700 dark:text-white dark:hover:text-gray-300"> {{__('profile.appName')}} </a>
