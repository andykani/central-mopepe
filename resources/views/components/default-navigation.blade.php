...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    ...
    <div class="flex items-center md:order-2">
        <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
          ...
          <img class="w-8 h-8 rounded-full" src="https://media.istockphoto.com/id/1289220545/fr/photo/belle-femme-souriant-avec-les-bras-crois%C3%A9s.webp?s=612x612&w=is&k=20&c=KLzR9CG9HwGYAcEUBKdqJ2j3JcU_LiobW26VhXDViBI=" alt="user photo">
        </button>
        <!-- Dropdown menu -->
